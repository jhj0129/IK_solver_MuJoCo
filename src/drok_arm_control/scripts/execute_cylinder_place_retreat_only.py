...
CONFIRMATION_TEXT = "EXECUTE_PLACE_RETREAT_ONLY"
...
class TransferExecutor(Node):
    def __init__(
        ...
        super().__init__(
            "cylinder_place_retreat_only_executor"
        )
    ...
    def execute(
        ...
        self.get_logger().info(
            "PLACE_RETREAT_ONLY: goal accepted"
        )
...
def main() -> int:
    ...
    print("=" * 88)
    print("CYLINDER PLACE RETREAT ONLY")
    print("=" * 88)
    ...
    try:
        ...
        print()
        print("=" * 88)
        print("PLACE RETREAT RESULT: PASS")
        print("=" * 88)
