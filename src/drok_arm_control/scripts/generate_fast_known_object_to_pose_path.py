...
BASE_GENERATOR_PATH = (
    ROOT
    / "src/drok_arm_control/scripts/generate_box_to_box_path_fast.py"
)
...
def main() -> int:
    ...
    print("=" * 80)
    print("FAST KNOWN OBJECT POSE TO EXACT VR TARGET PATH GENERATION")
    print("=" * 80)
    ...
    print()
    print("=" * 80)
    print("FAST EXACT VR TARGET PATH GENERATION: PASS")
    print("=" * 80)
