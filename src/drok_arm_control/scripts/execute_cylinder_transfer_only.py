...
CONFIRMATION_TEXT = "EXECUTE_TRANSFER_ONLY"
...
class TransferExecutor(Node):
    def __init__(
        ...
        super().__init__(
            "cylinder_transfer_only_executor"
        )
...
def main() -> int:
    ...
    print(
        "Expected motion : "
        "PICK_LIFT 종료점에서 PLACE 상공까지 수평 이동"
    )
